    ...
    return (
        ...
        <Flex style={{ flexDirection: "column" }}>
            <Stack mb={2} style={{  flexDirection:"row", flex:2 , height:50 }} > 
                ...
                {selectedCustomers.length && <><Button onClick={() => Router.push('/admin/sendMail')} style={{ backgroundColor: "#422AFB", height: 50, marginLeft: 15, marginTop: 0 }}>Multiple Emails</Button> <Button onClick={() => Router.push('/admin/print')} style={{ backgroundColor: "#2196F3", height: 50, marginLeft: 15, marginTop: 0 }}>Print client(s)</Button></>}
            </Stack>
